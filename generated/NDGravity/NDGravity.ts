...
export class NDGravity__getGravatarResult {
  value0: string;
  value1: string;
...
export class NDGravity__gravatarsResult {
  value0: Address;
  value1: string;
  value2: string;
...
export class NDGravity extends ethereum.SmartContract {
  static bind(address: Address): NDGravity {
    return new NDGravity("NDGravity", address);
  }

  getGravatar(owner: Address): NDGravity__getGravatarResult {
    ...
    return new NDGravity__getGravatarResult(
      result[0].toString(),
      result[1].toString()
    );
  }
  ...
  try_getGravatar(
    owner: Address
  ): ethereum.CallResult<NDGravity__getGravatarResult> {
    ...
    return ethereum.CallResult.fromValue(
      new NDGravity__getGravatarResult(value[0].toString(), value[1].toString())
    );
  }
  ...
  gravatars(param0: BigInt): NDGravity__gravatarsResult {
    let result = super.call(
      "gravatars",
    ...
    return new NDGravity__gravatarsResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toString()
    );
  ...
  try_gravatars(
    param0: BigInt
  ): ethereum.CallResult<NDGravity__gravatarsResult> {
    let result = super.tryCall(
      "gravatars",
      "gravatars(uint256):(address,string,string)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NDGravity__gravatarsResult(
        value[0].toAddress(),
        value[1].toString(),
        value[2].toString()
      )
